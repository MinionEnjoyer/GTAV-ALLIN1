...
Target **0.6.7**, Tauri **v2**. `manager.bat` / `allin1-gui` forward to the
...
clean source and the [milestone gates](../docs/release-0.6.7.md#remaining-work).
...
See [release scope](../docs/release-0.6.7.md) and
