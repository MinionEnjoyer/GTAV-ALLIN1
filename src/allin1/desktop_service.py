...
POPULATION_MODULES = {"ped_manager": "ped", "weapon_manager": "weapon", "vehicle_manager": "traffic"}
...
def population_backend(kind):
    # Explicit imports keep the public action surface closed and frozen builds
    # aware of each runtime-policy module.
    from allin1 import ped_population, weapon_population, traffic_population
    return {"ped": ped_population, "weapon": weapon_population, "traffic": traffic_population}[kind]
