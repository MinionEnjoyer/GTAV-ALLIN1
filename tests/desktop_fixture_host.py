...
def main():
    ...
    versioning.fetch_latest_release = lambda: versioning.ReleaseInfo("0.6.8", "https://github.com/MinionEnjoyer/GTAV-ALLIN1/releases/latest", True, "Synthetic next release")
