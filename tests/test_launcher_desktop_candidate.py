...
@pytest.mark.parametrize("name", ["tkinter", "tkinter.ttk", "_tkinter.pyd", "_internal/tcl86t.dll", "_internal/tk86t.dll", "_internal/_tcl_data/init.tcl", "_internal/_tk_data/tk.tcl", "tkinter/__init__.pyc", "PIL.ImageTk", "runtime/lib/PIL/ImageTk.py", "runtime/lib/PIL/_imagingtk.cp313-win_amd64.pyd", "runtime/lib/PIL/_imagingtk.pyi", "runtime/lib/PIL/_tkinter_finder.py", "allin1.gui", "allin1.customization_ui"])
