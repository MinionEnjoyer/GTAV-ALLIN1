...
- Suppressors Enhanced is an optional, separately imported script package. It is not part of `ALLIN1.dll` or ALLIN1 Online Content, and GBAY does not require it.
...
### Standalone Suppressors Enhanced does not provide a stealth bonus

- In **Packages**, confirm the separately imported **Suppressors Enhanced** package is installed and enabled. It is not supplied by Install / Repair or ALLIN1 Online Content.
- Open **Content**, select **Suppressors Enhanced**, enable **Realistic suppressor stealth**, apply the setting, and reload scripts or restart Story Mode.
...
- Heat simulation requires the standalone **Suppressors Enhanced** package, but it does not require its **Realistic suppressor stealth** setting. Apply the package settings and reload scripts or restart Story Mode.
