...
static inline void invoke(UINT64 hash) {
	nativeInit(hash);
	nativeCall();
}

template <typename T1>
static inline void invoke(UINT64 hash, T1 p1) {
	nativeInit(hash);
	nativePush(p1);
	nativeCall();
}
...
static inline void invoke(UINT64 hash, T1 p1, T2 p2) {
	nativeInit(hash);
	nativePush(p1);
	nativePush(p2);
	nativeCall();
...
static inline void invoke(UINT64 hash, T1 p1, T2 p2, T3 p3) {
	nativeInit(hash);
	nativePush(p1);
	nativePush(p2);
	nativePush(p3);
...
static inline void invoke(UINT64 hash, T1 p1, T2 p2, T3 p3, T4 p4) {
	nativeInit(hash);
	nativePush(p1);
	nativePush(p2);
	nativePush(p3);
...
static inline void invoke(UINT64 hash, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5) {
	nativeInit(hash);
	nativePush(p1);
	nativePush(p2);
	nativePush(p3);
...
static inline void invoke(UINT64 hash, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6) {
	nativeInit(hash);
	nativePush(p1);
	nativePush(p2);
	nativePush(p3);
...
static inline void invoke(UINT64 hash, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7) {
	nativeInit(hash);
	nativePush(p1);
	nativePush(p2);
	nativePush(p3);
...
static inline void invoke(UINT64 hash, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8) {
	nativeInit(hash);
	nativePush(p1);
	nativePush(p2);
	nativePush(p3);
